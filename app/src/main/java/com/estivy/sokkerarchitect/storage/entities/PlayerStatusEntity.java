...
public class PlayerStatusEntity {
    ...
    @Ignore
    public PlayerStatusEntity(Long id, Long playerId, Integer skillForm, Integer skillExperience,
                              Integer skillTeamwork, Integer skillDiscipline, Integer transferList,
                              Integer skillStamina, Integer skillPace, Integer skillTechnique,
                              Integer skillPassing, Integer skillKeeper, Integer skillDefending,
                              Integer skillPlaymaking, Integer skillScoring, TrainingType trainingType,
                              Integer officialMinutes, Integer unofficialMinutes, Integer trainerSkill,
                              Long week, Integer age, Boolean injured) {
        this.id = id;
    ...
    public Integer getSkillForm() { return skillForm; }
    public void setSkillForm(Integer skillForm) { this.skillForm = skillForm; }
    ...
    public Integer getSkillTeamwork() { return skillTeamwork; }
    public void setSkillTeamwork(Integer skillTeamwork) { this.skillTeamwork = skillTeamwork; }

    public Integer getSkillDiscipline() { return skillDiscipline; }
    public void setSkillDiscipline(Integer skillDiscipline) { this.skillDiscipline = skillDiscipline; }

    public Integer getTransferList() { return transferList; }
    public void setTransferList(Integer transferList) { this.transferList = transferList; }

    public Integer getSkillStamina() { return skillStamina; }
    public void setSkillStamina(Integer skillStamina) { this.skillStamina = skillStamina; }

    public Integer getSkillPace() { return skillPace; }
    public void setSkillPace(Integer skillPace) { this.skillPace = skillPace; }

    public Integer getSkillTechnique() { return skillTechnique; }
    public void setSkillTechnique(Integer skillTechnique) { this.skillTechnique = skillTechnique; }

    public Integer getSkillPassing() { return skillPassing; }
    public void setSkillPassing(Integer skillPassing) { this.skillPassing = skillPassing; }

    public Integer getSkillKeeper() { return skillKeeper; }
    public void setSkillKeeper(Integer skillKeeper) { this.skillKeeper = skillKeeper; }

    public Integer getSkillDefending() { return skillDefending; }
    public void setSkillDefending(Integer skillDefending) { this.skillDefending = skillDefending; }

    public Integer getSkillPlaymaking() { return skillPlaymaking; }
    public void setSkillPlaymaking(Integer skillPlaymaking) { this.skillPlaymaking = skillPlaymaking; }

    public Integer getSkillScoring() { return skillScoring; }
    public void setSkillScoring(Integer skillScoring) { this.skillScoring = skillScoring; }
    ...
    public static class Builder {
        ...
        public Builder injured(Boolean injured) { this.injured = injured; return this; }

        public PlayerStatusEntity build() {
            return new PlayerStatusEntity(id, playerId, skillForm, skillExperience, skillTeamwork, skillDiscipline,
                    transferList, skillStamina, skillPace, skillTechnique, skillPassing, skillKeeper,
                    skillDefending, skillPlaymaking, skillScoring, trainingType, officialMinutes, unofficialMinutes,
                    trainerSkill, week, age, injured);
        }
    }
